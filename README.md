...
|5|[Longest Palindromic Substring](https://github.com/Kelv1nYu/LeetCode_Practices/blob/master/Problems/Longest_Palindromic_Substring.md)|Medium|Python3|String, <br>Dynamic Programming|O(log(min(m,n)))|O(1)|
