...
|5|[Longest Palindromic Substring](https://github.com/Kelv1nYu/LeetCode_Practices/blob/master/Review/Python3/Longest_Palindromic_Substring.md)|Medium|Python3|String, <br>Dynamic Programming|O(n)|O(n)|
